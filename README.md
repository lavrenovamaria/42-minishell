...
## Cursor control using termcap library(описание характеристик терминалов). Либо readline либо эта штука
<details>
  <summary>Cursor control using termcap library(описание характеристик терминалов) </summary>
...
```
<p align="left">
	<img  src="https://user-images.githubusercontent.com/84707645/153202547-574bd816-3cff-4af6-8be3-2f89a77d9ecd.gif" width="550" height="450" /> 
</p>
